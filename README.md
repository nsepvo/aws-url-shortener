...
- DynamoDB over RDS — short codes map directly to long URLs, making a key-value store a natural fit. DynamoDB's partition key design mirrors this relationship exactly, and its atomic operation support is essential for safe concurrent writes
